...
class TestVarasto(unittest.TestCase):
    ...
    def test_lisays_lisataan_liikaa(self):
    ...
    def test_ottaminen_negatiivinen_ei_ota(self):
        self.varasto.lisaa_varastoon(8)
    ...
    def test_ottaminen_otetaan_liikaa(self):
        self.varasto.lisaa_varastoon(8)
